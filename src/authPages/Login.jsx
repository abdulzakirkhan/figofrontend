...
import { useLoginMutation, useLoginWithGoogleMutation } from '../redux/auth/authApi';
...
export const Login = () => {
  ...
  //     console.log("res :",res?.twoFARequired)
    ...
    <div className="flex h-screen bg-app text-app overflow-hidden">
      ...
      className="w-full pl-10 pr-4 py-3 border border-gray-300 bg-white text-black placeholder-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div className="grid grid-cols-1 gap-4 justify-center items-center">
                {/* <button className="flex items-center cursor-pointer justify-center gap-2 py-3 px-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
                ...
                <TFA showTwoFAInput={showTwoFAInput} setShowTwoFAInput={setShowTwoFAInput} twoFAEmail={twoFAEmail} setTwoFAEmail={setTwoFAEmail}/>
